  ...
  const [data, setData] = useState<any>({
    ...
    datasets: [
      ...
      },
      {
        ...
        data: [],
        fill: true,
        borderColor: "hsl(267, 100%, 40%)",
        backgroundColor: "hsl(267, 100%, 40% , 0.5)",
      ...
      },
      {
        ...
        backgroundColor: "hsl(300, 100%, 60%, 0.5)",
        pointBackgroundColor: "rgb(176, 58, 238)",
        pointHoverBorderColor: "rgb(176, 58, 238)",
      },
      {
        label: "Companies",
        data: [],
        ...
        backgroundColor: "hsl(350, 100%, 60%, 0.5)",
